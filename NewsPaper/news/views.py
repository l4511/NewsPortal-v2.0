...
class PostCreate(PermissionRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        new_post = Post(post_type=request.POST['post_type'],
                       ...
                       post_author=Author.objects.get(pk=request.POST['post_author']),  #request.POST['author'] Author.objects.get(pk=request.POST[''])
                       )
        #newpost.save()
    ...
    def get_initial(self):
        ...
        author = Author.objects.get(author=user) #user
